...
<style>
    ...
    /* INI KUNCI BIAR SEJAJAR 3 KOLOM */
    .queue-grid {
        display: grid;
    ...
    .poli-title {
        background: #0f52ba; color: white; padding: 15px 20px; margin: 0;
        font-size: 1.2rem; text-align: center;
    }
    .styled-table { width: 100%; border-collapse: collapse; }
    .styled-table th, .styled-table td { padding: 12px 15px; text-align: left; }
    .styled-table th { background-color: #f4f6f8; color: #333; font-weight: bold; border-bottom: 2px solid #ddd; }
    .styled-table td { border-bottom: 1px solid #eee; color: #555; }
    .styled-table tbody tr:hover { background-color: #f9f9f9; }
    .no-data { text-align: center; padding: 20px; color: #999; font-style: italic; }
    .badge-no { background: #e0e7ff; color: #0f52ba; padding: 5px 10px; border-radius: 6px; font-weight: bold; }

    /* INI @MEDIA NYA DITARUH DI SINI */
...
<div class="queue-container">
    ...
    <div class="queue-grid">
        <?php
        // 1. Ambil 3 data poli dari database
        ...
        ?>
            ...
            <div class="poli-card">
                ...
                <table class="styled-table">
                    ...
                    <tbody>
                        <?php
                        // 3. Ambil data pasien dengan perintah JOIN
                        $query_antrean = "
